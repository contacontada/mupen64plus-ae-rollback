...
> **Versão atual:** Patch 42. Esta atualização mantém as correções dos Patches 38 e 39 e o diagnóstico nativo do Patch 41, corrigindo a sincronização entre as threads de rollback e emulação para que o input latched seja visível de forma consistente.

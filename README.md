...
> **Versão atual:** Patch 39. Esta atualização mantém as correções do Patch 38 e torna explícito o ciclo de vida do serviço de rollback, evitando que ele seja encerrado quando a Activity do lobby perde a tarefa durante uma partida.

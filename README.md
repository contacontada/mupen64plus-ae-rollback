...
> **Versão atual:** Patch 41. Esta atualização mantém as correções dos Patches 38 e 39 e adiciona diagnóstico nativo do caminho de input do rollback, gravado no arquivo `rollback_debug.log` para facilitar a investigação de entradas não sincronizadas.
